      ...
      <div className="flex-1 bg-[#FFFAF0] ">
        <div className="flex justify-center items-center">
          <div className="flex m-6">
            ...
            <button className="w-15 h-10 rounded-lg bg-[#FF873C] cursor-pointer">
              search
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 p-4">
          {Info.map((info, index) => (
            <div className="flex flex-col">
              <div
                key={index}
                className="flex flex-col border-1 border-stone-400  rounded-lg p-4 max-w-sm justify-center items-center mx-auto md:mx-0 min-w-90 md:min-w-62 "
              >
              ...
              <div className="flex justify-center items-center">
                <div className=" border-1 border-stone-400 w-10 h-10 flex justify-center items-center rounded-lg m-2">
